...
\urlstyle{same}
\hypersetup{
  pdftitle={Client Report (Placeholder)},
...
\includegraphics{main_files/figure-latex/Boxplots-1.pdf} \#\#\# 3.3
Scatter Plot
...
\begin{center}\includegraphics[width=0.75\linewidth]{main_files/figure-latex/data quality-1} \end{center}
