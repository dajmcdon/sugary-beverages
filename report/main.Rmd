...
```{r Boxplots, fig.cap="The boxplots display the sales distribution of Sugary and Zero-Calorie beverages across various interventions. Each intervention is colour-coded and shows the range of sales data, warning=FALSE, with the central line representing the median sales.", echo=FALSE, fig.height=3, fig.width=6, fig.pos="H"}
...
### 3.4 Missing Values and Data Imbalance
